 ...
 * grant_type=password
 */
declare type PasswordGrantOptions = {
    grantType: 'password';
    /**
     * OAuth2 client id
     */
 ...
 */
declare type ClientCredentialsGrantOptions = {
 ...
 */
declare type AuthorizationCodeGrantOptions = {
 ...
 */
declare type RefreshOnlyGrantOptions = {
    grantType: undefined;
    /**
     * OAuth2 client id
     */
...
export declare type OAuth2Options = PasswordGrantOptions | ClientCredentialsGrantOptions | AuthorizationCodeGrantOptions | RefreshOnlyGrantOptions;
